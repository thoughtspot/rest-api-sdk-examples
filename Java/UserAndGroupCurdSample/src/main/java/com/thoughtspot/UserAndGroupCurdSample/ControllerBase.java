...
public class ControllerBase {
     ...
     * @throws ApiException .
     */
    public String getToken(String baseURL, String userName,
                           String password) throws IOException, ApiException {
     ...
     * @throws ApiException .
     */
    public RESTAPISDKClient getClient(String baseURL, String userName,
                                      String password) throws IOException, ApiException {
